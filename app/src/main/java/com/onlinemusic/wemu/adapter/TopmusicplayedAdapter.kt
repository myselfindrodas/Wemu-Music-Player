...
class TopmusicplayedAdapter(var context: Context,
                            var onItemClickListener: TopmusicplayedAdapter.OnItemClickListener
) :
    RecyclerView.Adapter<TopmusicplayedAdapter.MyViewHolder>()  {
    var sessionManager: SessionManager? = null
    var modelList: MutableList<CommonDataModel1> = arrayListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v: View = LayoutInflater.from(context).inflate(R.layout.top_music_adapter_container, parent, false)
