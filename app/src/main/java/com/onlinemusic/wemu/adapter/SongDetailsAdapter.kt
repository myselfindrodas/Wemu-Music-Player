...
class SongDetailsAdapter(var context: Context,
                         var onItemClickListener: OnItemClickListener
) :
    RecyclerView.Adapter<SongDetailsAdapter.MyViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        if (sessionManager?.getTheme().equals("night")){
            ...
            holder.songs_desc.setTextColor(context.resources.getColor(R.color.black))
...
//            context.startActivity(intent)
    ...
    private fun showPopupWindow(
        ...
        holder: SongDetailsAdapter.MyViewHolder
    ) {
    ...
    fun updateData(mModelList: List<CommonDataModel1>){
        modelList.clear()
